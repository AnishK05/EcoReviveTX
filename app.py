    ...
    try:
        ...
        if simulation_type:
            if simulation_type == "basic":
                simulation_result = run_c_simulation('simulations/basic_ecosystem_modeling.exe', mat, map_, soil_depth, climate, ecosystem)
            elif simulation_type == "monte_carlo":
                simulation_result = run_c_simulation('simulations/monte_carlo_ecosystem_modeling.exe', mat, map_, soil_depth, climate, ecosystem)
        else:
